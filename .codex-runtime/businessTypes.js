...
export function isBusinessTypeId(value) {
    return BUSINESS_TYPE_MAP.has(value);
}
export function getBusinessTypeConfig(businessType) {
    return BUSINESS_TYPE_MAP.get(businessType);
}
export function getBusinessTypeReportLabel(businessType) {
    return getBusinessTypeConfig(businessType).reportLabel;
}
export function getBusinessTypeSelectorLabel(businessType) {
    return getBusinessTypeConfig(businessType).selectorLabel;
}
export function getBusinessTypeBenchmark(businessType) {
