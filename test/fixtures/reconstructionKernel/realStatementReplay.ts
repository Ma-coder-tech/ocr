...
const wells: RealStatementReplayCase = {
  ...
  definition: {
    ...
    bindings: [
      ...
      single({ id: "wells.batch.0923.ref", observationKind: "identifier", expectedValue: "486205231035", section: "summary by batch", rowPattern: /^(486205231035) \| 09\/23\/24 \|/, captureGroup: 1, parseAs: "string" }),
      single({ id: "wells.batch.0924.ref", observationKind: "identifier", expectedValue: "486205241036", section: "summary by batch", rowPattern: /^(486205241036) \| 09\/24\/24 \|/, captureGroup: 1, parseAs: "string" }),
