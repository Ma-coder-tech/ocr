...
export const wellsFargoSeptember2024: ReconstructionInput = {
  ...
  observations: [
    ...
    observation(wellsDocument, "wells.batch.0923.ref", "identifier", "486205231035", "09/23 submitted batch"),
    observation(wellsDocument, "wells.batch.0924.ref", "identifier", "486205241036", "09/24 submitted batch"),
