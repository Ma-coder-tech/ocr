...
describe("Open-World Determinant & Unknown-Fee Analysis v1", () => {
  ...
  it("calibrates the full 11-statement Gold corpus, stops when determinants suffice, and preserves unresolved layers", async () => {
    ...
    expect(metrics).toEqual({
      ...
      beforeActionableRows: 160,
      beforeActionableDollarsMinor: 833_058,
      exactIdentitySupported: 97,
      familyKnownIdentityUnresolved: 245,
      identityAndLayerUnresolved: 141,
      determinantSufficient: 316,
      actionableClassified: 331,
      highMaterialityRows: 65,
      actionableHighMaterialityRows: 52,
      explainedMaterialDollarsMinor: 1_276_060,
      actionableClassifiedDollarsMinor: 1_276_060,
      unexplainedMaterialDollarsMinor: 364_030,
      researchEscalations: 144,
      researchStoppedBySufficiency: 317,
      exactIdentityUnresolvedNotQueued: 245,
      queued: 152,
      stage0SuppressedExternalResearch: 14,
      newlyWarrantedOutsideOpenWorldProjection: 22,
    });
