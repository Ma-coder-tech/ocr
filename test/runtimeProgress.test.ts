  ...
  it("admits only enumerated stages, bounded identifiers, safe counters, and reason codes", () => {
    expect(normalizeRuntimeProgressEvent({
      ...
      counters: {
        ...
        batchTopLevelEvidenceCount: 8,
        batchUniqueTopLevelEvidenceCount: 8,
        batchValidTopLevelEvidenceCount: 8,
        batchRejectedTopLevelEvidenceCount: 0,
        batchForeignTopLevelEvidenceCount: 0,
        batchDuplicateTopLevelEvidenceCount: 0,
        batchMalformedTopLevelEvidenceCount: 0,
        batchRowAdmittedEvidenceCount: 8,
        batchMissingTopLevelEvidenceCount: 0,
        batchEvidenceLinkageExactCount: 1,
      },
