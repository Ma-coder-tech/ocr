...
|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| OPENAI_DIRECT | gpt-5.2-2025-12-11 | SCHEMA_CONTROL | FAILED | SAFETY_BLOCKED | 1395 | 1294 | 20558 | 22234 | yes | — | exactCitedReferenceTokens_wrong_reference_class, hypothesis.supportingReferenceTokens_wrong_reference_class |
...
| OPENROUTER | openai/gpt-5.2-20251211 | SCHEMA_CONTROL | FAILED | UNAVAILABLE | 0 | 0 | 0 | 0 | yes | — | shadow_planner_openrouter_model_or_endpoint_rejected |
| OPENROUTER | openai/gpt-5.2-20251211 | ADVERSARIAL_REFERENCE_CONTROL | SKIPPED | — | 0 | 0 | 0 | 0 | yes | — | — |
| OPENROUTER | openai/gpt-5.2-20251211 | GOLD_CONTROL | SKIPPED | — | 0 | 0 | 0 | 0 | yes | — | — |
