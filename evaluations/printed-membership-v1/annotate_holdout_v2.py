"""Source-only annotation transcription, written before opening revised engine results.

These explicit source regions are evaluation gold, never engine parameters.
All 10 supplemental original source pages were visually reviewed. Native fragments transcribe
...
REGIONS = {
 'holdout-4': [('batch',[(256,378,390,2)],256,401.9,'$1,000.00'),
               ('transaction',[(256,650,683,2)],256,684.2,'-$2.24'),
               ('account',[(257,146,159,2)],257,169.4,'-$1.51')],
 'holdout-5': [('batch',[(260,425,457,4)],260,469.1,'$1,000.00'),
               ('transaction',[(261,160,269,8)],261,270.2,'-$18.64'),
               ('account',[(261,295,299,1)],261,308.6,'-$0.38')],
 'holdout-6': [('batch',[(264,648,679,4)],264,690.9,'$2,400.00'),
               ('transaction',[(265,340,470,10)],265,471.3,'-$11.00'),
               ('account',[(265,496,499,1)],265,509.7,'-$0.48')],
}
...
out = ROOT / 'evaluations/printed-membership-v1/holdout-v2-gold.json'
