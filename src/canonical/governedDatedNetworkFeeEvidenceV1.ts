...
const NXGEN_NOTICE_REF = "doc_e78a35bfe868b57c";
...
const NOTICES: GovernedNetworkNoticeEvent[] = [
  ...
  notice("b3_notice_nxgen_star_annual", NXGEN_NOTICE_REF, "fiserv_NXGEN_VORTAX_Sep_2022.pdf#pages-1-3-extraction-rows-25-28", NXGEN_STAR_EXCERPT, "STAR", "network_merchant_location", "announced_mechanic_change", "2022-11-01", "participating enabled location or website with June-August 2022 STAR activity", "the addressed merchant account", "annual per participating location or website", null, 16, "usd_per_year_per_location_or_website", "The notice announced changed billing criteria and a $16 STAR network annual fee under the stated location/website and activity criteria."),
  notice("b3_notice_nxgen_accel_annual", NXGEN_NOTICE_REF, "fiserv_NXGEN_VORTAX_Sep_2022.pdf#pages-1-3-extraction-rows-29-31,57-60", NXGEN_ACCEL_EXCERPT, "ACCEL", "network_merchant_location", "announced_mechanic_change", "2022-12-01", "participating enabled location or website with June-August 2022 ACCEL activity", "the addressed merchant account", "annual per participating location or website", null, 16, "usd_per_year_per_location_or_website", "The notice announced changed billing criteria and a $16 ACCEL network annual fee under the stated location/website and activity criteria."),
  notice("b3_notice_nxgen_interlink_integrity_postponed", NXGEN_NOTICE_REF, "fiserv_NXGEN_VORTAX_Sep_2022.pdf#page-10-lines-350-352", NXGEN_POSTPONED_EXCERPT, "Visa", "network_exception_or_integrity_family", "postponed", null, "Interlink System Integrity", "the addressed merchant account", "unresolved", null, null, null, "The notice postponed the Interlink System Integrity fee from the October 2022 release to an unspecified future release."),
  notice("b3_notice_nxgen_emv_fallback_postponed", NXGEN_NOTICE_REF, "fiserv_NXGEN_VORTAX_Sep_2022.pdf#page-10-lines-350-352", NXGEN_POSTPONED_EXCERPT, "Visa", "network_exception_or_integrity_family", "postponed", null, "EMV fallback", "the addressed merchant account", "unresolved", null, null, null, "The notice postponed the EMV Fallback fee from the October 2022 release to an unspecified future release."),
];
...
function notice(
  ...
  return {
    ...
    effectiveDatePrecision: announcedEffectiveFrom === null ? "unresolved" : sourceDocumentRef === NXGEN_NOTICE_REF ? "month" : "day",
    effectiveThrough: null,
