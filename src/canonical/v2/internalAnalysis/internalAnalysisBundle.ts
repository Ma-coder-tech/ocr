...
export async function writeInternalAnalysisBundle(outputDirectory: string, analysis: InternalStatementAnalysisV1,
  ...
  const files = [
    ["internal-analysis.json", `${JSON.stringify(analysis, null, 2)}\n`], ["internal-analysis.md", formatInternalAnalysisMarkdown(analysis, sources)],
...
export function formatInternalAnalysisMarkdown(analysis: InternalStatementAnalysisV1, sources: PublicSourceEvidenceManifestV1): string {
