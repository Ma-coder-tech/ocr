...
function validateAdmission(
  ...
  if (analysis.economicLayer.semanticApplications.length > 0 &&
      !["runtime_capability", "claim_scoped_fee_occurrence"].includes(profile.source)) {
...
function validateCostStack(analysis: CanonicalEconomicsV2EconomicAnalysis, errors: string[]): void {
  ...
  if (feeFact.status !== "available" && analysis.economicLayer.admissionProfile.source !== "claim_scoped_fee_occurrence" &&
