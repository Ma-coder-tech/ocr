...
export function validateInvestigativeMember(value: unknown, expected: { itemId: string; questionId: string; candidateId: string; documentId: string; documentFingerprint: string; claimType: SemanticVerificationInput["question"]["claimType"]; sourceAuthority: string }): string[] {
