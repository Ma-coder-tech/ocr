...
export function serializeWholeStatementFeeIntelligenceProviderInput(
  ...
  return [
    ...
    "Return top-level evidenceRefs as the unique exact union of rowInterpretations[].evidenceRefs. Use only canonical evidence IDs present in admittedFeeRows[].evidenceRefs; never return source-occurrence refs such as srcocc_*.",
