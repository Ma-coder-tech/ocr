...
export const RUNTIME_CHECKPOINT_COUNTER_KEYS = [
  ...
  "batchOrdinal",
  "batchExpectedRowCount",
  "batchReturnedRowCount",
  "batchUniqueReturnedRowCount",
  "batchMissingRowCount",
  "batchDuplicateRowCount",
  "batchUnknownRowCount",
  "batchCrossBatchRowCount",
  "batchMalformedRowCount",
  "batchAttemptCount",
  "batchStructuredOutputCompletedCount",
  "batchTopLevelEvidenceCount",
  "batchUniqueTopLevelEvidenceCount",
  "batchValidTopLevelEvidenceCount",
  "batchRejectedTopLevelEvidenceCount",
  "batchForeignTopLevelEvidenceCount",
  "batchDuplicateTopLevelEvidenceCount",
  "batchMalformedTopLevelEvidenceCount",
  "batchRowAdmittedEvidenceCount",
  "batchMissingTopLevelEvidenceCount",
  "batchEvidenceLinkageExactCount",
  "eligibleItemCount",
  "admittedItemCount",
  "projectionCount",
] as const;
